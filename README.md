...
Early version of a standard GeoPoseProtocol API i.e. a request/response protocol for visual localization. The OGC GeoPose encoding has been standardized with contributions from OARC members and can be read here [OGC GeoPose Standard](https://docs.ogc.org/is/21-056r11/21-056r11.html).
